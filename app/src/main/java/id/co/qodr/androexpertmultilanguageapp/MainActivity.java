package id.co.qodr.androexpertmultilanguageapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPlural = (TextView) findViewById(R.id.tv_plurals);
        tvXliff = (TextView) findViewById(R.id.tv_xliff);

        int pokeCount = 3;
        String hello = String.format(getResources().getString(R.string.hello_world), "Abdurrahman", pokeCount, "QODR");
